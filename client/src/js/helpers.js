      ...
      if (typeof speechToText !== 'undefined' && speechToText !== null) {
        ...
        toggler.forEach(el => {
          ...
          el.addEventListener('click', () => {
            el.closest('.input-group').querySelector('.form-control form-control-sm').focus()
            ...
            recognition.onresult = event => {
              el.closest('.input-group').querySelector('.form-control form-control-sm').value = event.results[0][0].transcript
            }
