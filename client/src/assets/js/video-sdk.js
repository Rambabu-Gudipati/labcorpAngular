...
async function tokenGeneration() {
  TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlrZXkiOiI3ODJkY2E1My0wNmE4LTRjYjMtYjdjMy1jZDZhNGQ0Y2YwZjMiLCJwZXJtaXNzaW9ucyI6WyJhbGxvd19qb2luIl0sImlhdCI6MTczMjUxNzQ0MywiZXhwIjoxNzMzMTIyMjQzfQ.E3yG5rcPRo8NFywonzpAeQOkEQ_XyylxXgXFXlg0MGM";
  if (TOKEN != "") {
    token = TOKEN;
    console.log(token);
  } else if (AUTH_URL != "") {
