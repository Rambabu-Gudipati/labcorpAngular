...
@Component({
  selector: 'app-list-doctor-consultation',
  
  templateUrl: './list-doctor-consultation.component.html',
  styleUrl: './list-doctor-consultation.component.scss'
})
export class ListDoctorConsultationComponent implements OnInit{
  loading: any;
  // dtElement: any;
